...
void circle(struct headerBMP *hb, void *bm,int xx,int yy ,int rr,char bcc,char gcc,char rcc){
	...
	for (ddd=0.0;ddd<xyr+1.0;ddd=ddd+1.0){
		...
		x1=(int)d1;
		y1=(int)dd1;
		line(hb,bm,x,y,x1,y1,bcc,gcc,rcc);
	}

}

void ball(struct headerBMP *hb, void *bm,int xx,int yy ,int rr,char bcc,char gcc,char rcc){
	long double rrr=(long double)rr,dx=(long double)xx,dy=(long double)yy,ddddd=0.0,d1=0.0,dd1=0,d=0.0,dd=0.0,ddd=0.0,pi=(long double)PI;
	int x=1,y=1,bc=0,c=7,x1=0,y1=0;
	long double rrr1=rrr*2;
	...
	for (ddd=0.0;ddd<xyr/2;ddd=ddd+1.0){
		...
		x1=(int)d1;
		y1=(int)dd1;
		hline(hb,bm,x1,y,x,bcc,gcc,rcc);
	}
